...
namespace eHR.PMS.Web.Controllers
{
    public class Stage2ApprovalController : BaseController
    {
        ...
        public JsonResult KPISave(string[] KPIForDatabase)
        {
            ...
            Model.PMSModel.UpdateAppraisalKPIComment(lst_comments, lst_delete_comments, out message);
        ...
        public JsonResult CoreValuesSave(string[] KPIForDatabase)
        {
            ...
            Model.PMSModel.UpdateAppraisalCoreValueComment(lst_comments, lst_delete_comments, out message);
            return Json(new { message = message, kpiid = newcommentsidarray });
        }
